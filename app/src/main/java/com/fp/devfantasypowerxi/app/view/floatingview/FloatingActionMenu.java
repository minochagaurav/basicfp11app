...
public class FloatingActionMenu extends ViewGroup {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mLabelsColorNormal = attr.getColor(R.styleable.FloatingActionMenu_menu_labels_colorNormal, R.color.colorPrimary);
        mLabelsColorPressed = attr.getColor(R.styleable.FloatingActionMenu_menu_labels_colorPressed, R.color.colorPrimary);
        mLabelsColorRipple = attr.getColor(R.styleable.FloatingActionMenu_menu_labels_colorRipple, R.color.colorPrimary);
        mMenuShowShadow = attr.getBoolean(R.styleable.FloatingActionMenu_menu_showShadow, true);
        mMenuShadowColor = attr.getColor(R.styleable.FloatingActionMenu_menu_shadowColor, R.color.colorPrimary);
        ...
        mMenuColorNormal = attr.getColor(R.styleable.FloatingActionMenu_menu_colorNormal, R.color.colorPrimary);
        mMenuColorPressed = attr.getColor(R.styleable.FloatingActionMenu_menu_colorPressed, R.color.colorPrimary);
        mMenuColorRipple = attr.getColor(R.styleable.FloatingActionMenu_menu_colorRipple, R.color.colorPrimary);
        ...
        if (mIcon == null) {
            mIcon = getResources().getDrawable(R.drawable.ic_plus_icon);
        }

...
import com.fp.devfantasypowerxi.databinding.LayoutSliderImageBinding

class SliderBannerAdapter(var context: Context, var urls: ArrayList<Banner>, var isForAddCash: Boolean) :
    PagerAdapter() {
    ...
    override fun instantiateItem(container: ViewGroup, position: Int): Any {
        val layoutSliderImageBinding: LayoutSliderImageBinding = DataBindingUtil.inflate(
            LayoutInflater.from(context),
            R.layout.layout_slider_image,
            container,
            false
        )
